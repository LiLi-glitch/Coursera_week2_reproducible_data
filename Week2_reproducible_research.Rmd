...
week <-plot(meansteps_2_week$meansteps ~ meansteps_2_week$interval, type = "l", xlab = "5 min interval", ylab = "average steps per day"
    )

weekend <- plot(meansteps_2_weekend$meansteps ~ meansteps_2_weekend$interval, type = "l", xlab = "5 min interval", ylab = "average steps per day"
    )
